...
exports.calculateGeneralStats = calculateGeneralStats;
exports.calculateParticipantStats = calculateParticipantStats;
...
function calculateParticipantStats(data) {
    const messages = data.messages.filter(m => !m.isSystem);
    const participantMap = {};
    for (const m of messages) {
        if (!participantMap[m.participant])
            participantMap[m.participant] = [];
